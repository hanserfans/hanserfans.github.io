...
export default function ArticleEditor({ filename, onCancel, onSave }) {
  ...
  return (
    <div className="space-y-4">
        ...
        {isEditing ? (
          previewMode ? (
            ...
            <textarea
              ...
              className="w-full h-[600px] p-4 font-mono text-sm border-none rounded-lg focus:ring-0 bg-white"
      ...
      <div className="text-xs text-gray-500 text-center">
        内容长度: {content?.length || 0} 字符 | 编辑长度: {editContent?.length || 0} 字符
      </div>
    </div>
  )
}